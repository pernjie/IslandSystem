...
public class ViewPoProdBean implements Serializable {
    ...
    @EJB
    private ScmBean sb;
    //@ManagedProperty(value="#{poProdBean}")
    //private PoProdBean poProdBean;
...
// Replace with your real name and NUSNET email address
    ...
    public ViewPoProdBean() {
    }
    /*
    public void setPoProdBean(PoProdBean poProdBean) {
        this.poProdBean = poProdBean;
    }
    */
    @PostConstruct
    public void init() {
        ...
        try {
            //poRecord = poProdBean.getPoRecord();
    ...
    public void sendPoInven() throws IOException {
        String toEmailAddress = sup.getContactEmail();
