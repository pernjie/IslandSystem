...
@ManagedBean(name = "demandManagementBean")
@SessionScoped
public class DemandManagementBean implements Serializable {
    ...
    public void validateInput() throws IOException {
        ...
        if (valid == true) {
            ...
            context.redirect("mrp_mrp.xhtml");
        }
    }
}
