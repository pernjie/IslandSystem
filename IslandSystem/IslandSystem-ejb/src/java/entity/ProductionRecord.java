...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "ProductionRecord.findAll", query = "SELECT p FROM ProductionRecord p"),
    @NamedQuery(name = "ProductionRecord.findById", query = "SELECT p FROM ProductionRecord p WHERE p.id = :id"),
    @NamedQuery(name = "ProductionRecord.findByPeriod", query = "SELECT p FROM ProductionRecord p WHERE p.period = :period"),
    @NamedQuery(name = "ProductionRecord.findByYear", query = "SELECT p FROM ProductionRecord p WHERE p.year = :year")})
public class ProductionRecord implements Serializable {
    ...
    public ProductionRecord(Long id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ProductionRecord)) {
            return false;
        }
        ProductionRecord other = (ProductionRecord) object;
    ...
    public String toString() {
        return "entity.ProductionRecord[ id=" + id + " ]";
    }
